...
import org.localstorm.extraction.jsonpath.internal.PathTokenizer;
import org.localstorm.extraction.jsonpath.internal.Utils;
import org.localstorm.extraction.jsonpath.internal.filter.PathTokenFilter;
import org.localstorm.extraction.jsonpath.spi.HttpProviderFactory;
...
public class JsonPath {
    ...
    public <T> T read(Object jsonObject) {
        return read(jsonObject, org.localstorm.extraction.jsonpath.Configuration.defaultConfiguration());
    }
     ...
     * @return list of objects matched by the given path
     */
    public <T> T read(Object jsonObject, org.localstorm.extraction.jsonpath.Configuration configuration) {
    ...
    public <T> T read(String json) {
        return read(json, org.localstorm.extraction.jsonpath.Configuration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(String json, org.localstorm.extraction.jsonpath.Configuration configuration) {
    ...
    public <T> T read(URL jsonURL) throws IOException {
        return read(jsonURL, org.localstorm.extraction.jsonpath.Configuration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(URL jsonURL, org.localstorm.extraction.jsonpath.Configuration configuration) throws IOException {
    ...
    public <T> T read(File jsonFile) throws IOException {
        return read(jsonFile, org.localstorm.extraction.jsonpath.Configuration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(File jsonFile, org.localstorm.extraction.jsonpath.Configuration configuration) throws IOException {
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(InputStream jsonInputStream, org.localstorm.extraction.jsonpath.Configuration configuration) throws IOException {
        notNull(jsonInputStream, "json input stream can not be null");
        notNull(configuration, "configuration can not be null");
     ...
     */
    public static ParseContext using(org.localstorm.extraction.jsonpath.Configuration configuration){
    ...
    public static ParseContext using(JsonProvider provider){
        return new JsonReader(org.localstorm.extraction.jsonpath.Configuration.builder().jsonProvider(provider).build());
    }

    /**
     * Parses the given JSON input using the default {@link org.localstorm.extraction.jsonpath.Configuration} and
    ...
    /**
     * Parses the given JSON input using the provided {@link org.localstorm.extraction.jsonpath.Configuration} and
     * returns a {@link ReadContext} for path evaluation
     *
     * @param json input
     * @return a read context
     */
    public static ReadContext parse(Object json, org.localstorm.extraction.jsonpath.Configuration configuration) {
     ...
     * @return a read context
     */
    public static ReadContext parse(String json, org.localstorm.extraction.jsonpath.Configuration configuration){
        return new JsonReader(configuration).parse(json);
    }
     ...
     * @return a read context
     */
    public static ReadContext parse(InputStream json, org.localstorm.extraction.jsonpath.Configuration configuration) {
        return new JsonReader(configuration).parse(json);
    }
     ...
     * @return a read context
     */
    public static ReadContext parse(File json, org.localstorm.extraction.jsonpath.Configuration configuration) throws IOException {
        return new JsonReader(configuration).parse(json);
    }
     ...
     * @return a read context
     */
    public static ReadContext parse(URL json, org.localstorm.extraction.jsonpath.Configuration configuration) throws IOException {
        return new JsonReader(configuration).parse(json);
    }
}
