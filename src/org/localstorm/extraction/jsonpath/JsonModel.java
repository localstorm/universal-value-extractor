 ...
 */
package org.localstorm.extraction.jsonpath;

import org.localstorm.extraction.jsonpath.internal.JsonFormatter;
import org.localstorm.extraction.jsonpath.internal.JsonReader;
import org.localstorm.extraction.jsonpath.internal.PathToken;
import org.localstorm.extraction.jsonpath.internal.Utils;
import org.localstorm.extraction.jsonpath.spi.JsonProvider;
import org.localstorm.extraction.jsonpath.spi.JsonProviderFactory;
import org.localstorm.extraction.jsonpath.spi.MappingProviderFactory;
...
public class JsonModel {
    ...
    private org.localstorm.extraction.jsonpath.Configuration configuration;
    ...
    //
    // --------------------------------------------------------
    private JsonModel(Object jsonObject, org.localstorm.extraction.jsonpath.Configuration configuration) {
     ...
     * be definite ({@link JsonPath#isPathDefinite()}).
     * <p/>
    ...
    public JsonModel getSubModel(JsonPath jsonPath) {
        ...
        if (!configuration.getProvider().isContainer(subModel)) {
            throw new org.localstorm.extraction.jsonpath.InvalidModelException("The path " + jsonPath.getPath() + " returned an invalid model " + (subModel != null ? subModel.getClass() : "null"));
        }
    ...
    public static JsonModel model(JsonProvider jsonProvider, String json) {
        ...
        return new JsonModel(new JsonReader(jsonProvider).parse(json).json(), org.localstorm.extraction.jsonpath.Configuration.builder().jsonProvider(jsonProvider).build());
    }
    ...
    public static JsonModel model(JsonProvider jsonProvider, Object jsonObject) {
        ...
        return new JsonModel(jsonObject, org.localstorm.extraction.jsonpath.Configuration.builder().jsonProvider(jsonProvider).build());
    }
    ...
    public static JsonModel model(JsonProvider jsonProvider, URL url) throws IOException {
        ...
        return new JsonModel(new JsonReader(jsonProvider).parse(url).json(), org.localstorm.extraction.jsonpath.Configuration.builder().jsonProvider(jsonProvider).build());
    }
    ...
    public static JsonModel model(JsonProvider jsonProvider, InputStream jsonInputStream) throws IOException {
        ...
        return new JsonModel(new JsonReader(jsonProvider).parse(jsonInputStream).json(), org.localstorm.extraction.jsonpath.Configuration.builder().jsonProvider(jsonProvider).build());
    }
    ...
    private <T> T getTargetObject(JsonPath jsonPath, Class<T> clazz) {
        ...
        if (!jsonPath.isPathDefinite()) {
            throw new org.localstorm.extraction.jsonpath.IndefinitePathException(jsonPath.getPath());
        }
        ...
        if (jsonPath.getTokenizer().size() == 1) {
            ...
            if (modelRef.getClass().isAssignableFrom(clazz)) {
                throw new org.localstorm.extraction.jsonpath.InvalidModelException(jsonPath + " does nor refer to a Map but " + currentToken.getClass().getName());
            }
            return clazz.cast(modelRef);
        }
        throw new org.localstorm.extraction.jsonpath.InvalidModelException();
    }
    ...
    public interface ObjectMappingModelReader {
        /**
         * Converts this JsonModel to the specified class using the configured {@link org.localstorm.extraction.jsonpath.spi.MappingProvider}
         *
    ...
    public interface ListMappingModelReader {
        /**
         * Converts this JsonModel to the a list of objects with the provided class using the configured {@link org.localstorm.extraction.jsonpath.spi.MappingProvider}
         *
        ...
        /**
         * Converts this JsonModel to the a {@link List} of objects with the provided class using the configured {@link org.localstorm.extraction.jsonpath.spi.MappingProvider}
         *
         * @param targetClass class to convert the {@link JsonModel} array items to
         * @param <T>         template class
         * @return the mapped mode
        ...
        /**
         * Converts this JsonModel to the a {@link Set} of objects with the provided class using the configured {@link org.localstorm.extraction.jsonpath.spi.MappingProvider}
         *
         * @param targetClass class to convert the {@link JsonModel} array items to
         * @param <T>         template class
         * @return the mapped model
    ...
    public interface ObjectOps {
         ...
         * with the {@link Object} returned by the {@link Transformer#transform(Object, org.localstorm.extraction.jsonpath.Configuration)}
         *
    ...
    private static class JsonSubModel extends JsonModel {
        ...
        private JsonSubModel(Object jsonObject, org.localstorm.extraction.jsonpath.Configuration configuration, JsonModel parent, JsonPath subModelPath) {
