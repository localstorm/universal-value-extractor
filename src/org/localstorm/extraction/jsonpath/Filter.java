 ...
 * </code>
 *
 * @see org.localstorm.extraction.jsonpath.Criteria
 *
...
public abstract class Filter<T> {
     ...
     * @return a new filter
     */
    public static Filter filter(org.localstorm.extraction.jsonpath.Criteria criteria) {
     ...
     */
    public abstract Filter addCriteria(org.localstorm.extraction.jsonpath.Criteria criteria);
    ...
    public static abstract class FilterAdapter<T> extends Filter<T> {
        ...
        @Override
        public Filter addCriteria(org.localstorm.extraction.jsonpath.Criteria criteria) {
    ...
    private static class MapFilter extends FilterAdapter<Map<String, Object>> {
        ...
        private HashMap<String, org.localstorm.extraction.jsonpath.Criteria> criteria = new LinkedHashMap<String, org.localstorm.extraction.jsonpath.Criteria>();

        public MapFilter(org.localstorm.extraction.jsonpath.Criteria criteria) {
            addCriteria(criteria);
        }

        public MapFilter addCriteria(org.localstorm.extraction.jsonpath.Criteria criteria) {
            org.localstorm.extraction.jsonpath.Criteria existing = this.criteria.get(criteria.getKey().getPath());
        ...
        public boolean accept(Map<String, Object> map, Configuration configuration) {
            for (org.localstorm.extraction.jsonpath.Criteria criterion : this.criteria.values()) {
